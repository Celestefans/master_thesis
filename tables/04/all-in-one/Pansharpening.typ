#figure(
  caption: [不同 all-in-one 方法在 Pansharpening 任务上的对比结果，最优结果用 #strong[粗体]表示，次优结果用 #underline[下划线]表示],
  kind: table,
)[
  #set text(size: 9pt)
  #table(
    ...
    [AdaIR],        [#underline[43.46]], [#underline[1.06]], [#underline[0.85]], [#underline[49.90]], [#underline[0.75]], [#underline[0.54]], [51.80], [0.47], [0.54],
    [PromptIR],     [43.34], [1.08], [0.88], [49.76], [0.76], [0.55], [#underline[52.20]], [#underline[0.46]], [#underline[0.53]],
    [MAGNet],       [*44.01*], [*0.99*], [*0.81*], [*50.15*], [*0.74*], [*0.53*], [*52.52*], [*0.44*], [*0.52*],
