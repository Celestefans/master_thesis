#figure(
  ...
  #table(
    ...
    [AdaIR],        [10.2M], [#underline[44.27]], [*0.9928*], [38.92], [0.9780], [35.56], [#underline[0.9585]],
    [PromptIR],     [28.5M], [44.16], [#underline[0.9926]], [#underline[38.97]], [#underline[0.9781]], [#underline[35.58]], [0.9582],
    [VPNet],        [4.7M],  [*44.34*], [*0.9928*], [*39.02*], [*0.9783*], [*35.59*], [*0.9589*],
    
    table.hline(stroke: 1.2pt),
  )
] <VPNet_all-in-one_mri>